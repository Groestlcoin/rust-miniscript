...
use miniscript::groestlcoin::secp256k1::{Secp256k1, Verification};
use miniscript::groestlcoin::{Address, Network};
use miniscript::{DefiniteDescriptorKey, Descriptor, DescriptorPublicKey};

const XPUB_1: &str = "xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcFF8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhkJ8UB7WEnLmau";
const XPUB_2: &str = "xpub69H7F5d8KSRgmmdJg2KhpAK8SR3DjMwAdkxj3ZuxV27CprR9LgpeyGmXUbC6wb7ERfvrnKZjXoUmmDznezpbZb7ap6r1D3tgFxHmwLQLwEp";
...
fn p2wsh<C: Verification>(secp: &Secp256k1<C>) -> Address {
    ...
    let expected = groestlcoin::Address::from_str(
...
fn p2sh_p2wsh<C: Verification>(secp: &Secp256k1<C>) -> Address {
    ...
    let expected = Address::from_str("325zcVBN5o2eqqqtGwPjmtDd8dJRxDf35A").unwrap();
    assert_eq!(address, expected);
    address
}
