...
impl<Pk: MiniscriptKey> Policy<Pk> {
    ...
    ///
    /// ```
    /// use miniscript::{groestlcoin::{hashes::hash160, PublicKey}, policy::semantic::Policy, Translator};
    ...
    /// pk_map.insert(String::from("alice_pk"), groestlcoin::PublicKey::from_str(alice_pk).unwrap());
    /// pk_map.insert(String::from("bob_pk"), groestlcoin::PublicKey::from_str(bob_pk).unwrap());
